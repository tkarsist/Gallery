...
<table border="2" width="80%" align="center">
	<tr>
		...
		<a href="vertailu.php">Päivitä </a><br>
		...
		?>
			...
			<?php if($_SESSION['alb_filter']=="NotInAlb"){echo " selected ";} ?>
				value="NotInAlb">Ei missään albumissa</option>
		</select></form>
...
<input type="submit" name="rem_view" value="Poista näkymästä">
...
<?php
		...
		foreach($_SESSION['kuva_taulu'] as $key => $nimi){
			...
			echo '</script></li>';
			*/
			echo '<div class="img"><a href="detailed_vertailu.php?kuva='.$nimi.'"><img src="'.$location."thumb"."/".$nimi.'.thumb.jpg"></a>'."\n";
			//echo '<div>';
			echo '<br>';
			echo '<script type="text/javascript" language="javascript">';
			echo 'document.write('."'".'<a id="'.$nimi.'" href="#" onclick="toggleStylishCheckbox'."(\'";
