...
// Code for Session Cookie workaround
        if (isset($_POST["HAKEMISTO"])) {
			$save_path=$base_dir.$_POST['HAKEMISTO']."/";
        	//                session_id($_POST["ALBUMI"]);
        } else if (isset($_GET["HAKEMISTO"])) {
		$save_path=$base_dir.$_GET['HAKEMISTO']."/";
...
// Settings
        ...
        #$save_path = $full_dir;
        //$save_path = $_SESSION['hakemisto']; 
        #$save_path = "/tmp/roska/jikku/";                              // The path were we will save the file (getcwd() may not be reliable and should be tested in your environment)
